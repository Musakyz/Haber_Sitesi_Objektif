...
<img style="height:  400px;" src="salgın.jpg">
<p>Bilim insanları covid-19dan daha ölümcül virüs olucağını ortaya çıkardı.2030 yılında covid-19dan daha ölümcül virüs ortaya çıkacak.</p>
<br><br>
...
<form action='veriler4.php' method='post'>
       <textarea name='yorum'> </textarea><br><input type='submit' value='yorum yap'>
       </form>
       <?php 
 $sql = "SELECT yorum FROM haber where id=4";

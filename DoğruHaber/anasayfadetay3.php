...
<img style="height:  400px;" src="bilim1.jfif">
<p>Nasadan korkutan göktaşı açıklaması göktaşı dünyaya yaklaşıyor.</p>
<br><br>
<table width="322" border="0" align="left">
    ...
    <tr>
     ...
     <form method="post" action="anketoyla10">
    <tr>
...
<form method="post" action="anketoyla11">
    <tr>
...
<form method="post" action="anketoyla12">
    <tr>
...
<form method="post" action="anketoyla13">
    <tr>
...
<form method="post" action="anketoyla14">
    <tr>
...
<form action='veriler3.php' method='post'>
       <textarea name='yorum'> </textarea><br><input type='submit' value='yorum yap'>
       </form>
       <?php 
 $sql = "SELECT yorum FROM haber where id=3";

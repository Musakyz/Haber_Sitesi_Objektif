...
<img style="height:  400px;" src="ekonomim1.jpg">
<p>Hak iş genel başkanı işcinin ücretinin giderek eridiğini vurguladı yüksek vergiler yüzünden işcinin alım gücünün giderek azaldığını söyledi.</p>
<br><br>
...
<form action='veriler8.php' method='post'>
       <textarea name='yorum'> </textarea><br><input type='submit' value='yorum yap'>
       </form>
       <?php 
 $sql = "SELECT yorum FROM haber where id=8";

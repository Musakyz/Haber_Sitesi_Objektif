...
<img style="height:  400px;" src="salgın2.jpg">
<p>İzmirde yapılan bilim fuarı bilimin birleştirici etkisini ortaya koydu.Bilimin uluslar arası barışa katkısını ortaya koydu</p>
<br><br>
...
<form action='veriler6.php' method='post'>
       <textarea name='yorum'> </textarea><br><input type='submit' value='yorum yap'>
       </form>
       <?php 
 $sql = "SELECT yorum FROM haber where id=6";

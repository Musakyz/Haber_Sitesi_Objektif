...
<img style="height:  400px;" src="sporum2.jpg">
<p>Mohamed'in kolundaki bandanada Mostafa Mohamed'in 3 ay önce dünyaya gelen Oday Mostafa Mohamed'in adının yazdığı öğrenildi.</p>
<br><br>
...
<form action='veriler11.php' method='post'>
       <textarea name='yorum'> </textarea><br><input type='submit' value='yorum yap'>
       </form>

       <?php 
 $sql = "SELECT yorum FROM haber where id=11";

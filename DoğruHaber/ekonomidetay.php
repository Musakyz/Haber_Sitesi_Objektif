...
<img style="height:  400px;" src="ekonomim.jfif">
<p>Cumhurbaşkanı Recep Tayyip Erdoğan ekonomimizin iyi olduğunu söyledi.</p>
<br><br>
...
<form action='veriler7.php' method='post'>
       <textarea name='yorum'> </textarea><br><input type='submit' value='yorum yap'>
       </form>
       <?php 
 $sql = "SELECT yorum FROM haber where id=7";

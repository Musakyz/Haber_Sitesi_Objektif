...
<img style="height:  400px;" src="ekonomim2.jpg">
<p>Türkiye’de son dönemde zam üstüne zam gelirken Enerji Ticaret Derneği Başkanı Burak Kuyan, dikkat çeken bir açıklamada bulundu. Başkan Kuyan, elektriğe yüzde 40-45 oranında zam yapılması gerektiğini dile getirdi.</p>
<br><br>
...
<form action='veriler9.php' method='post'>
       <textarea name='yorum'> </textarea><br><input type='submit' value='yorum yap'>
       </form>
       <?php 
 $sql = "SELECT yorum FROM haber where id=9";

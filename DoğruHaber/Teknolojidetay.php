...
<img style="height:  400px;" src="teknoloji1.jpg">
<p>Türk bilim adamları batarya sorununa çare buldular.Bitmeyen batarya buldular.</p>
<br><br>
...
<form action='veriler13.php' method='post'>
       <textarea name='yorum'> </textarea><br><input type='submit' value='yorum yap'>
       </form>

       <?php 
 $sql = "SELECT yorum FROM haber where id=13";

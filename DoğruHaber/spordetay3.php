...
<img style="height:  400px;" src="sporum3.jpg">
<p>Trabzonspor kulüp doktoru Op. Dr. Hakan Çelik Fenerbahçe maçında sakatlanarak karşılaşmaya devam edemeyen Bruno Peres ve Anthony Nwakaeme'nin sağlık durumlarıyla ilgili açıklamada bulundu.

Hakan Çelik, yaptığı açıklamada "Dün oynadığımız müsabakada sakatlanan Bruno Peres'in çekilen MR'ında sağ diz iç yan bağda ikinci derece yırtık tespit edilmiş olup oyuncumuzun tedavisine başlanmıştır. Yine aynı müsabakada sağ kalçasında gerilme hisseden Anthony Nwakaeme'nin ise tedavisine başlanmış olup yarın MR çekilmesi planlanmaktadır"</p>
<br><br>
...
<form action='veriler12.php' method='post'>
       <textarea name='yorum'> </textarea><br><input type='submit' value='yorum yap'>
       </form>

       <?php 
 $sql = "SELECT yorum FROM haber where id=12";
